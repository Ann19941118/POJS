class Job:
    def __init__(self, Job_index, Operation_num):
        ...
        self.Last_Processing_Machine = []  # 工件上一工序的加工机器
        self.Last_Processing_end_time = []  # 工件上一工序的结束时间
    ...
    def _Input(self, W_Eailiest, End_time, Machine):
        ...
        :return:
        """
        self.Last_Processing_Machine.append(W_Eailiest)
        self.Last_Processing_end_time.append(End_time)
